"""
Скрипт для анализа финансовых данных и оценки прибыльности стратегии.
Загружает данные из pickle-файла, включая признаки и целевые значения.
Формирует векторы сигналов и определяет направление движения цены.
Моделирует сделки по заданным условиям для расчёта прибыли/убытка (P/L).
Вычисляет кумулятивный профит и строит график его динамики во времени.
Результаты выводятся в консоль и сохраняются в виде PNG-графика.
Использует pandas, matplotlib и seaborn для обработки и визуализации.
"""
